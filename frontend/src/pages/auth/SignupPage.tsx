...
export const SignupPage: React.FC = () => {
  ...
  const getPasswordStrength = (pass: string) => {
    let score = 0;
    if (!pass) return { label: 'Empty', color: 'bg-gray-200', percent: 0 };
    ...
    switch (score) {
      ...
      case 3:
        return { label: 'Good', color: 'bg-brand-500', percent: 75 };
      case 4:
      default:
    ...
    <div className="bg-white p-6 sm:p-8 rounded-2xl border border-edge shadow-card w-full">
      ...
      <button
        ...
        onClick={() => {
          ...
          setPassword('GoogleOAuthDemo123!');
          setConfirmPassword('GoogleOAuthDemo123!');
          setAgreeTerms(true);
          setTimeout(() => {
